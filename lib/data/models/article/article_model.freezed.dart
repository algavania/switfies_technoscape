...
mixin _$ArticleModel {
  ...
  int get readingInMinutes => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      content: null == content
          ...
          : content // ignore: cast_nullable_to_non_nullable
              as String,
      readingInMinutes: null == readingInMinutes
          ? _value.readingInMinutes
          : readingInMinutes // ignore: cast_nullable_to_non_nullable
              as int,
      id: freezed == id
          ? _value.id
...
class _$_ArticleModel implements _ArticleModel {
  ...
  @override
  String toString() {
    return 'ArticleModel(title: $title, thumbnailUrl: $thumbnailUrl, content: $content, readingInMinutes: $readingInMinutes, id: $id, documentSnapshot: $documentSnapshot, createdAt: $createdAt)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.readingInMinutes, readingInMinutes) ||
                other.readingInMinutes == readingInMinutes) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, thumbnailUrl, content,
      readingInMinutes, id, documentSnapshot, createdAt);
...
abstract class _ArticleModel implements ArticleModel {
  const factory _ArticleModel(
      ...
      required final int readingInMinutes,
      @JsonKey(includeFromJson: false, includeToJson: false) final String? id,
      @JsonKey(includeFromJson: false, includeToJson: false)
      final DocumentSnapshot<Object?>? documentSnapshot,
      @TimestampConverter()
      required final DateTime createdAt}) = _$_ArticleModel;
